            ...
            <div className="mx-4 p-4">
                <div className="flex items-center">
                    ...
                    <div className="flex items-center text-gray-500 relative">
                        ...
                        <div className="absolute top-9 -ml-6 text-center mt-16 w-32 text-xl font-medium uppercase text-gray-500">Speciality</div>
                    </div>
                    <div className="flex-auto border-t-2 transition duration-500 ease-in-out border-gray-300"></div>
                    <div className="flex items-center text-gray-500 relative">
                        <div className="rounded-full transition duration-500 ease-in-out h-20 w-20 py-3 border-2 border-gray-300">
                    ...
                    <div className="flex items-center text-gray-500 relative">
                        ...
                        <div className="absolute top-6 -ml-6 text-center mt-16 w-32 text-xl font-medium uppercase text-gray-500">Jobs</div>
                    </div>
                </div>
            </div>
