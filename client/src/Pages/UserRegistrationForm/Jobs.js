    ...
    return (
        <div className="p-5 bg-gray-900 mt-5">
            <div className="mx-4 p-4">
                <div className="flex items-center">
                    ...
                    <div className="flex items-center text-white relative">
                        ...
                        <div className="absolute top-9 -ml-6 text-center mt-16 w-32 text-xl font-medium uppercase text-teal-600">Jobs</div>
                    </div>
                </div>
            </div>
            <div className="mt-8 p-4">
                ...
                text-teal-100 
                border duration-200 ease-in-out 
                border-teal-600 transition" onClick={console.log("SUBMIT")}>Submit</button>
