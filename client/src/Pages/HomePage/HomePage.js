...
const HomePage = () => {
  return (
    <div className="bg-gray-800">
      ...
      <div className="container mx-auto sm:mt-96  roles">
        <h1 className="text-center uppercase text-3xl	font-bold text-white pt-20">
          Popular roles
        </h1>
        <div className="grid grid-cols-5 sm:gap-20 lg:gap-20 md:gap-40">
          <button className="bg-teal-500 hover:bg-teal-400 text-black font-bold py-2 px-2 border-b-4 border-teal-700 hover:border-teal-500 rounded-full my-3 sm:h-20 sm:w-28 lg:h-16">
            Colourblind testing
          </button>
          <button className="bg-teal-500 hover:bg-teal-400 text-black font-bold py-2 px-2 border-b-4 border-teal-700 hover:border-teal-500 rounded-full my-3 sm:h-20 sm:w-28 lg:h-16">
            Game tester
